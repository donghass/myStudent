...
public class ProgressRepositoryImpl implements ProgressRepository {
        ...
        @Override
        public List<ProgressEntity> findByTextbookId(Long textbookId) {
                return queryFactory
                                .selectFrom(progress)
                                .where(progress.textbookId.eq(textbookId))
                                .orderBy(progress.lessonDate.desc())
                                .fetch();
        }

        @Override
        public Integer countByTextbookId(Long textbookId) {
